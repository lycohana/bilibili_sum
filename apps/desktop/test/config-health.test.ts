...
function createSettings(overrides: Partial<ServiceSettings> = {}): ServiceSettings {
  return {
    ...
    siliconflow_asr_chunk_duration_seconds: 1800,
    siliconflow_asr_concurrency: 2,
    multimodal_asr_base_url: "",
    multimodal_asr_model: "mimo-v2-omni",
    multimodal_asr_api_key: "",
    multimodal_asr_api_key_configured: false,
    multimodal_asr_chunk_duration_seconds: 180,
    multimodal_asr_max_retries: 5,
    cuda_variant: "cu128",
